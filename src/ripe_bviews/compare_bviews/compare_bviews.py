...
ixp1_to_compare = "ixbr.json"
ixp2_to_compare = "NAPAfrica.json"
def get_stats_from_compared_ixps(): 

    configs_ix1 = load_configs(ixp1_to_compare)
         
    configs_ix2 = load_configs(ixp2_to_compare)
