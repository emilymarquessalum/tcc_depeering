...
def get_reach_quality_of_reachables_from_asn(asn: str, stat: BGPDumpSnapshotStats): 
    ...
    times_the_asn_is_the_best_path = 0
    times_the_asn_is_not_the_best_path = 0
    ...
    for reachable in reachables:
        ...
        best_as_path_length_from_asn = stat.get_best_as_path_length_for_member_to_reach_asn(asn, reachable)[0]

        best_as__path_length_for_reachable = stat.get_best_as_path_length_for_reachable(reachable)[0]
        worst_as_path_length_for_reachable = stat.get_worst_as_path_length_for_reachable(reachable)[0]
         
        # the best can only be the worst if there is no other option
        if best_as__path_length_for_reachable == worst_as_path_length_for_reachable:
            times_the_asn_is_the_only_path_length += 1
            continue
  
        
        if best_as_path_length_from_asn == best_as__path_length_for_reachable:
            times_the_asn_is_the_best_path += 1
            continue

        times_the_asn_is_not_the_best_path += 1

        if best_as_path_length_from_asn == worst_as_path_length_for_reachable:
            times_the_asn_is_the_worst_path += 1

    print(f"For {asn}")
    print(f"Best paths: {times_the_asn_is_the_best_path}")
    print(f"Not best paths: {times_the_asn_is_not_the_best_path}")
    print(f"Worst paths: {times_the_asn_is_the_worst_path}")
