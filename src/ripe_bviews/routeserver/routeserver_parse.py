...
def extract_routeserver_data_from_tar_gz(tar_gz_file_path, start_date, end_date, routeserver_name="ix-br"):
    """
    Extract routeserver neighbor data from a tar.gz file for a date range.
    
    Args:
        tar_gz_file_path: Path to the tar.gz file
        start_date: datetime object for start date (e.g., datetime.datetime(2025, 8, 20))
        end_date: datetime object for end date (e.g., datetime.datetime(2025, 9, 20))
        routeserver_name: Name of the routeserver (default: "ix-br")
    """
