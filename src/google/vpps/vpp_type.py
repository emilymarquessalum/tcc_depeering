...
from src.caidapeeringdb.caidapeeringdb_load import get_all_files, get_asinfo_from_asn, get_asns_of_info_type, get_asns_types, get_data
...
asn_types_for_vpps = get_asns_types(data, vpp_asns)
